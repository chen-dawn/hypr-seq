...
if __name__ == '__main__':
    ...
    with open(args.stats_file, 'w') as stats, open(args.log_file, 'w') as log:
        print("COLLAPSE BARCODE IS RUNNING")
        # Edit to not generate plots
        collapse_beads_and_write_whitelist(args.groups_file, args.whitelist_file, args.filtered_whitelist_file, args.barcode_stats, args.overlap_mat, args.plots_file, log, stats, args.thresh, args.histogram_file, args.clustermap_png)
